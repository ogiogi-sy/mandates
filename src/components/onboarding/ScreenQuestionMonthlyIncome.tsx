...
interface ScreenQuestionMonthlyIncomeProps {
  onNext: (value: string) => void;
  onSaveExit: () => void;
  prefilled?: boolean;
}

const OPTIONS = ['£0 – £10k', '£10k – £50k', '£50k – £250k', '£250k+'];

export function ScreenQuestionMonthlyIncome({ onNext, onSaveExit, prefilled = false }: ScreenQuestionMonthlyIncomeProps) {
