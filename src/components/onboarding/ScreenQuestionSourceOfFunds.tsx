...
interface ScreenQuestionSourceOfFundsProps {
...
export function ScreenQuestionSourceOfFunds({ onNext, onSaveExit }: ScreenQuestionSourceOfFundsProps) {
  ...
  return (
    <ScreenBusinessQuestionLayout
      ...
      subtitle="What are your main sources of business funding? Select all that apply."
