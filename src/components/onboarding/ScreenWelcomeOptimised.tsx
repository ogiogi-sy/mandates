import { Building2, ShieldCheck, Clock, CheckCircle2, ArrowRight } from 'lucide-react';
import { StickyFooter } from './StickyFooter';

interface ScreenWelcomeOptimisedProps {
  onStart: () => void;
  onResume: () => void;
}

export function ScreenWelcomeOptimised({ onStart, onResume }: ScreenWelcomeOptimisedProps) {
  return (
